...
halifax <- tibble(
  date = seq.Date(date("2021-06-01"), date("2024-08-01"), by = "month"),
  halifax_prices = c(
    ...
    284039, 287244, ## 2023
    290608, 291338, 288781, 288862, 288931, 289042, 291585, 292505
  ),
  halifax_change = c(
