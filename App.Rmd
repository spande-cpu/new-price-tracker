...
halifax <- tibble(
  date = seq.Date(date("2021-06-01"), date("2024-02-01"), by = "month"),
  halifax_prices = c(
...
-   In a return to price growth, **developer list prices have risen by `r current_change[,15]`** in the period of Jan-Feb 2024 (v/s Halifax = `r current_change[,4]`, v/s Nationwide = `r current_change[,12]`), the largest monthly increase since May 2022.

-   In year-on-year terms, new-build **prices are above their levels from this time last year** and have remained markedly less volatile than prices across the aggregate market (∆NewBuild = `r current_change[,14]`, ∆Halifax = `r current_change[,3]`, ∆Nationwide = `r current_change[,11]`).

-   While developer list-prices continue to demonstrate some volatility across the smallest and largest property sizes, **prices across all property types, have remained close to or above 2023 levels**.
...
-   Developer pricing is more optimistic after a few periods of muted activity.

-   While the largest (4+ bedroom) and smallest (1 bedroom) properties continue to demonstrate higher monthly and year-on-year volatility, prices have ticked upwards across most developers in the Jan-Feb 2024 period.
