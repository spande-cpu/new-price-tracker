...
-   Prices continue their momentum and have risen for the 3rd month in a row.

-   **Developer list prices have risen by `r current_change[,15]`** in the period of Feb-Mar 2024 (v/s Halifax = `r current_change[,4]`, v/s Nationwide = `r current_change[,12]`). 

-   Across all indices, **prices are above their levels from this time last year** (∆NewBuild = `r current_change[,14]`, ∆Halifax = `r current_change[,3]`, ∆Nationwide = `r current_change[,11]`).
